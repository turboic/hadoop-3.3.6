...
public class CompositeService extends AbstractService {
    ...
    protected void addService(Service service) {
        ...
        LOG.info("将服务 service 添加到内存缓存serviceList之中去");
        synchronized (serviceList) {
    ...
    protected void serviceInit(Configuration conf) throws Exception {
        ...
        LOG.info(getName() + ": initing services, size=" + services.size());
    ...
    protected void serviceStart() throws Exception {
        List<Service> services = getServices();
        LOG.info(getName() + ": starting services, size=" + services.size());
        for (Service service : services) {
    ...
    protected void serviceStop() throws Exception {
        ...
        LOG.info(getName() + ": stopping services, size=" + numOfServicesToStop);
    ...
    private void stop(int numOfServicesStarted, boolean stopOnlyStartedServices) {
        ...
        for (int i = numOfServicesStarted - 1; i >= 0; i--) {
            ...
            LOG.info("Stopping service #" + i + ": " + service);
