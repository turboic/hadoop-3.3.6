...
public class AuxServices extends AbstractService implements ServiceStateChangeListener, EventHandler<AuxServicesEvent> {
    ...
    public static final FsPermission NM_AUX_SERVICE_DIR_PERM = new FsPermission((short) 0700);
    ...
    AuxServices(AuxiliaryLocalPathHandler auxiliaryLocalPathHandler, Context nmContext, DeletionService deletionService) {
        ...
        serviceRecordMap = Collections.synchronizedMap(new HashMap<String, AuxServiceRecord>());
    ...
    private boolean checkManifestPermissions(FileStatus status) throws IOException {
