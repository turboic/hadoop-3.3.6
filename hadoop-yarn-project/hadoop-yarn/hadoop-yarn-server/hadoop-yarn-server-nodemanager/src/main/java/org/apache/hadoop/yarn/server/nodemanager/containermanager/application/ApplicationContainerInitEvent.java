...
public class ApplicationContainerInitEvent extends ApplicationEvent {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ApplicationContainerInitEvent.class);
    ...
    public ApplicationContainerInitEvent(Container container) {
        ...
        LOG.info("容器id===【{}】", container.getContainerId().getApplicationAttemptId().getApplicationId());
        LOG.info("ApplicationEventType.INIT_CONTAINER ===【{}】", ApplicationEventType.INIT_CONTAINER);
