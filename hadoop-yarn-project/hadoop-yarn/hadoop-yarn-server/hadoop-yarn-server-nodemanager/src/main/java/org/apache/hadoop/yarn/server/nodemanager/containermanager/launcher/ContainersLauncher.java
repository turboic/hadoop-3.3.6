...
public class ContainersLauncher extends AbstractService implements AbstractContainersLauncher {
    ...
    @VisibleForTesting
    public ExecutorService containerLauncher = HadoopExecutors.newCachedThreadPool(new ThreadFactoryBuilder().setNameFormat("ContainersLauncher #%d").build());
    @VisibleForTesting
    ...
    public ContainersLauncher() {
        ...
        LOG.info("ContainersLauncher勾到方法被调用");
    }
    ...
    public void init(Context nmContext, Dispatcher nmDispatcher, ContainerExecutor containerExec, LocalDirsHandlerService nmDirsHandler, ContainerManagerImpl nmContainerManager) {
        ...
        LOG.info("ContainersLauncher的init方法被调用");
    ...
    protected void serviceInit(Configuration conf) throws Exception {
        try {
            ...
            LOG.info("serviceInit的配置=====【{}】并获取hdfs的上下文信息", conf);
    ...
    public void handle(ContainersLauncherEvent event) {
        ...
        switch (event.getType()) {
            ...
            case SIGNAL_CONTAINER:
                ...
                LOG.info("handle发送容器信号量 =====【{}】", running);
                break;
