...
public class ContainerLaunch implements Callable<Integer> {
  ...
  public ContainerLaunch(Context context, Configuration configuration,
    ...
    LOG.info("ContainerLaunch容器加载初始化");
  }
  ...
  public Integer call() {
    ...
    try {
      ...
      LOG.info("app的Id ===== {}",appIdStr);
      String relativeContainerLogDir = ContainerLaunch
          .getRelativeContainerLogDir(appIdStr, containerIdStr);

      LOG.info("relativeContainerLogDir ===== {}",relativeContainerLogDir);
      ...
      LOG.info("launchContext上下文加载命令 ===== {}",newCmds);
      ...
      LOG.info("launchContext上下文运行环境 ===== {}",environment);
  ...
  protected void handleContainerExitCode(int exitCode, Path containerLogDir) {
    ContainerId containerId = container.getContainerId();
    LOG.info("Container {} completed with exit code {}", containerId,
        exitCode);
