...
public class SchedulingMonitor extends AbstractService {
    ...
    public SchedulingMonitor(RMContext rmContext, SchedulingEditPolicy scheduleEditPolicy) {
        ...
        LOG.info("资源管理-调度策略是：" + scheduleEditPolicy.getPolicyName() + ",对应类是" + scheduleEditPolicy.getClass().getName());
        LOG.info("资源管理-调度监控构造方法初始化");
    }
    ...
    public void serviceStart() throws Exception {
        LOG.info("正在启动Starting SchedulingMonitor 线程的名称是 =" + getName());
    ...
    private void schedulePreemptionChecker() {
        ...
        LOG.info("固定速率" + handler.getClass().getName());
    }
