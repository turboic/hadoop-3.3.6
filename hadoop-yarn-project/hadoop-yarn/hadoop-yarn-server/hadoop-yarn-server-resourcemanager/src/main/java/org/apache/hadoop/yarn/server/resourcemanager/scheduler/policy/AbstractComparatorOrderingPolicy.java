...
public abstract class AbstractComparatorOrderingPolicy<S extends SchedulableEntity> implements OrderingPolicy<S> {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(OrderingPolicy.class);
    ...
    @Override
    public abstract void containerAllocated(S schedulableEntity, RMContainer r);
