...
public class ApplicationInitializationContext {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(ApplicationInitializationContext.class);
  ...
  public ApplicationInitializationContext(String user, ApplicationId applicationId,
    ...
    LOG.info("应用初始化上下文 user ==== {}",user);
    LOG.info("应用初始化上下文 applicationId ====  {}",applicationId);
    LOG.info("应用初始化上下文 appDataForService ====   {}",appDataForService);
  }
