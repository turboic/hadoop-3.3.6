...
public class ApiServiceClient extends AppAdminClient {
    ...
    public ApiServiceClient(Configuration c) throws Exception {
        serviceInit(c);
        LOG.info("创建API服务的客户端,鹿鹿");
    }

    @Override
    protected void serviceInit(Configuration configuration) throws Exception {
        yarnClient = YarnClient.createYarnClient();
        LOG.info("ApiServiceClient创建属性yarnClient={}", yarnClient);
        addService(yarnClient);
        LOG.info("ApiServiceClient将yarnClient添加到服务", "addService");

        LOG.info("ApiServiceClient调用父类的serviceInit方法");
                ...
                try {
                    ...
                    if (!useKerberos) {
                        try {
                            ...
                            LOG.error("Fail to resolve username: {}", e);
                        }
                    }
                    LOG.info("请求内容是 === {}", sb);
                    ...
                    if (useKerberos) {
                        ...
                        LOG.info("Authorization: Negotiate {}", challenge);
                    }
    ...
    private void appendUserNameIfRequired(StringBuilder builder) throws IOException {
        Configuration conf = getConfig();
     ...
     * @throws IOException
     */
    public Builder getApiClient(String requestPath) throws IOException {
     ...
     */
    public Service loadAppJsonFromLocalFS(String fileName, String serviceName, Long lifetime, String queue) throws IOException, YarnException {
    ...
    @Override
    public int actionCleanUp(String appName, String userName) throws IOException, YarnException, InterruptedException {
