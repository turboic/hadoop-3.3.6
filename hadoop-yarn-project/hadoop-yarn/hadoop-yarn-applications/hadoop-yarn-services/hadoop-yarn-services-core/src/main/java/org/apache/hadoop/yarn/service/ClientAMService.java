...
public class ClientAMService extends AbstractService implements ClientAMProtocol {
    ...
    protected void serviceStart() throws Exception {
        LOG.info("ClientAMService服务启动方法serviceStart");
        Configuration conf = getConfig();
        YarnRPC rpc = YarnRPC.create(conf);

        LOG.info("创建了Yarn的远程调用RPC ===== {}", rpc);
        String nodeHostString = getNMHostName();


        LOG.info("获取主机名称 ===== {}", nodeHostString);

        InetSocketAddress address = new InetSocketAddress(nodeHostString, 0);

        LOG.info("根据rpc获取server对象 ===== {}", server);
        ...
        if (conf.getBoolean(CommonConfigurationKeysPublic.HADOOP_SECURITY_AUTHORIZATION, false)) {
            LOG.info("Hadoop的安全认证设置 = {}", conf.getBoolean(CommonConfigurationKeysPublic.HADOOP_SECURITY_AUTHORIZATION, false));
        ...
        LOG.info("服务启动了，绑定地址 ===== {}", bindAddress);
    ...
    @Override
    public FlexComponentsResponseProto flexComponents(FlexComponentsRequestProto request) throws IOException {
    ...
    @Override
    public GetStatusResponseProto getStatus(GetStatusRequestProto request) throws IOException, YarnException {
    ...
    @Override
    public StopResponseProto stop(StopRequestProto requestProto) throws IOException, YarnException {
    ...
    @Override
    public UpgradeServiceResponseProto upgrade(UpgradeServiceRequestProto request) throws IOException {
        try {
    ...
    @Override
    public RestartServiceResponseProto restart(RestartServiceRequestProto request) throws IOException, YarnException {
    ...
    @Override
    public CompInstancesUpgradeResponseProto upgrade(CompInstancesUpgradeRequestProto request) throws IOException, YarnException {
    ...
    @Override
    public GetCompInstancesResponseProto getCompInstances(GetCompInstancesRequestProto request) throws IOException {
    ...
    @Override
    public CancelUpgradeResponseProto cancelUpgrade(CancelUpgradeRequestProto request) throws IOException, YarnException {
    ...
    @Override
    public DecommissionCompInstancesResponseProto decommissionCompInstances(DecommissionCompInstancesRequestProto request) throws IOException, YarnException {
